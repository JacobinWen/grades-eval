...
avg_semester_grades <- grades |>
  group_by(id, group) |>
  summarize(
    final_grade = mean(avg_course_grade, na.rm = TRUE), 
    avg_semester1 = mean(avg_course_grade[avg_course_grade[semester == 1]], na.rm = TRUE),
    avg_semester2 = mean(avg_course_grade[avg_course_grade[semester == 2]], na.rm = TRUE),
    .groups = "drop"
  )
```
